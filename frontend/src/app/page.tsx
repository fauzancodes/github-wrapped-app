    ...
    <>
      ...
      <main className="flex flex-wrap justify-center gap-8 pb-10">
        <p className="font-medium text-center !mx-5 w-full md:w-7/12">
          This desktop application is built with modern technologies to deliver high performance and an optimized user experience. Powered by <Link href="https://go.dev/" target="_blank">Go</Link> for data processing, <Link href="https://gorm.io/" target="_blank">GORM</Link> for efficient database connections, and <Link href="https://www.postgresql.org/" target="_blank">PostgreSQL</Link> as a reliable database, it ensures speed and robustness. On the frontend, <Link href="https://nextjs.org/" target="_blank">Next.JS</Link>, <Link href="https://tailwindcss.com/" target="_blank">TailwindCSS</Link>, and <Link href="https://daisyui.com/" target="_blank">DaisyUI</Link> are utilized to create a responsive and visually appealing UI/UX. All components are seamlessly integrated into a desktop application using <Link href="https://wails.io/" target="_blank">Wails</Link>, resulting in a professional and cohesive solution.
        </p>
        <p className="font-medium text-center !mx-5 w-full md:w-7/12">
